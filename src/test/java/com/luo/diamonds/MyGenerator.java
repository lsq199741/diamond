...
public class MyGenerator {
    public static void main(String[] args) {
        ...
        // 生成文件输出路径
        String outputDir = "/Users/luoshuqiang/work/java/diamonds/output";
        // 作者
        String authorName = "shuqiang";
        // 包名全路径
        String packageNameAllPath = "com.luo";
        // 模块名
        String moduleName = "diamonds";
        // 接口是否以I开头
        boolean serviceNameStartWithI = false;
        // 对应表
        String[] tableName = {"member", "member_role", "permission", "role", "role_permission"};

        String dbUrl = "jdbc:mysql://localhost:3306/diamonds?useSSL=false&useUnicode=true&characterEncoding=UTF8&allowPublicKeyRetrieval=true&serverTimezone=GMT";
